...
var baseUri = "https://itemservice-mort237d.azurewebsites.net/api/Cars";
...
var buttonByIdElement = document.getElementById("getByIdButton");
buttonByIdElement.addEventListener("click", showCarById);
var buttonSearchElement = document.getElementById("searchButton");
buttonSearchElement.addEventListener("click", showCarBySearch);
var selectedElement = document.getElementById("selector");
var buttonPriceRangeElement = document.getElementById("searcByPricehButton");
buttonPriceRangeElement.addEventListener("click", priceRangeCar);
var buttonPutElement = document.getElementById("changeCarButton");
buttonPutElement.addEventListener("click", putCar);
var putSelectedElement = document.getElementById("putSelector");
...
function Reset() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(baseUri + "/reset");
}
GetCarsToselector();
function GetCarsToselector() {
...
var ownerButton = document.getElementById("getAllOwnersButton");
...
function showAllOwners() {
    var output = document.getElementById("ownersContent");
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://itemservice-mort237d.azurewebsites.net/api/carowners")
        .then(function (response) {
        var result = "<table class='table table-bordered'><thead><tr><th>ID</th><th>Name</th><th>Cars</th></tr></thead><tbody>";
...
function showCarById() {
    var output = document.getElementById("idContent");
    var inputElement = document.getElementById("getInput");
...
function showCarBySearch() {
    var output = document.getElementById("searchContent");
    var inputElement = document.getElementById("getSearchInput");
    var id = inputElement.value;
    var uri = baseUri;
    var selector = selectedElement.value;
    if (selector === "model")
        uri += "/Model/" + id;
...
function priceRangeCar() {
    var output = document.getElementById("searchByPriceContent");
    var lowInputElement = document.getElementById("lowPriceInput");
    var highInputElement = document.getElementById("highPriceInput");
    var lowPrice = lowInputElement.value;
    var highPrice = highInputElement.value;
    var uri = baseUri + "/Search?LowPrice=" + lowPrice + "&HighPrice=" + highPrice;
...
function putCar() {
    var output = document.getElementById("putContent");
    var idInputElement = document.getElementById("idInput");
    var vendorInputElement = document.getElementById("vendorInput");
    var modelInputElement = document.getElementById("modelInput");
    var priceInputElement = document.getElementById("priceInput");
    var myId = idInputElement.value;
    var myVendor = vendorInputElement.value;
    var myModel = modelInputElement.value;
    var myPrice = priceInputElement.value;
    var uri = baseUri + "/" + myId;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.put(uri, { id: myId, model: myModel, vendor: myVendor, price: myPrice })
        .then(function (response) {
